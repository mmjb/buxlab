...
__all__ = ["Vocabulary", "split_identifier_into_parts"]
...
class Vocabulary(Sized):
    ...
    def __batch_add_from_counter(
        self,
        token_counter: typing.Counter[str],
        count_threshold: int,
        max_num_elements_to_add: int,
    ) -> None:
    ...
    def create_vocabulary(
        tokens: Union[Iterable[str], typing.Counter[str]],
        max_size: int,
    ...
    def update(
        ...
        """
        self.__batch_add_from_counter(
            token_counter,
            count_threshold=count_threshold,
            max_num_elements_to_add=max_num_elements_to_add,
        )

    def get_empirical_distribution(self, elements: Iterable[str], dirichlet_alpha: float = 10.0) -> np.ndarray:
